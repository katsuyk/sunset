	...
	<footer class="entry-footer">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'sunset' ), $categories_list ); ?>
			</span>
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'sunset' ), __( '1 Comment', 'sunset' ), __( '% Comments', 'sunset' ) ); ?></span>
		<?php endif; ?>
